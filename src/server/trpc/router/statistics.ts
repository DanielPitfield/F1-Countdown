...
export const statisticsRouter = router({
  getDriverWorldChampionshipHistory: publicProcedure.query(async (): Promise<DriverSeasonResult[]> => {
  ...
  getTeamWorldChampionshipHistory: publicProcedure.query(async (): Promise<TeamSeasonResult[]> => {
  ...
  getRaceWinnerHistoryPart1: publicProcedure.query(async (): Promise<Race[]> => {
  ...
  getRaceWinnerHistoryPart2: publicProcedure.query(async (): Promise<Race[]> => {
